...
function Hero({ backgroundImage, imageAlt, title, subtitle, buttonText, buttonUrl }) {
  return (
    ...
    <div className="absolute top-0 w-full h-4/5 flex flex-col items-center justify-center bg-cover bg-center text-center" style={{backgroundImage: `url(${backgroundImage})`}} aria-label={imageAlt} >
